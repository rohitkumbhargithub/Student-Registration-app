...
SECRET_KEY = 'django-insecure-m--2*hbk$@g540lx5w%6(wk@dh%(p@6$r5o8i6a5uq-u5mw3y#'
...
DATABASES['default'] = dj_database_url.parse('mysql://root:rohit123@localhost/student_register')
